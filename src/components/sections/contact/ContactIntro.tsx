      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-[#DBA668] mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            En ManosLibres nos importa tu experiencia. Este formulario de contacto es un espacio dedicado a:
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                ¿No entiendes cómo funciona algo? ¿Tienes preguntas sobre cómo usar ManosLibres?
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Tienes una idea brillante para mejorar ManosLibres? Nos encantaría escucharla.
